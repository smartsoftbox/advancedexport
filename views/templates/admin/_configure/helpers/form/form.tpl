            ...
            <div class="well text-right">
              ...
              <div class="row">
                ...
                <div class="additional-buttons">
                  <div class="col-md-5">
                    <a href="{$link|escape:'html'}&editfields=1" class="btn button btn-default" title="change global field name">
                      Global Field Name
                    </a>
                  </div>
                  <div  class="btn-group col-md-5">
                    <a href="{$link|escape:'html'}&addfield=1" class="btn button btn-default" title="add static field">
                      Add Static Field
                    </a>
                  </div>
              </div>
