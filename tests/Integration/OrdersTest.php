...
class OrdersTest extends IntegrationTestCase
{
    ...
    public function test_CsvFileData()
    {
        ...
        $this->assertSame($this->row['Total products'], '53.000000');
        ...
        $this->assertSame($this->row['Date added'], '2017-01-27 10:03:02');
        //array('name' => 'Date updated', 'field' => 'date_upd', 'database' => 'orders', 'alias' => 'o'),
        $this->assertSame($this->row['Date updated'], '2017-01-27 10:03:03');
        ...
        $this->assertSame($this->row['Customer id'], '1');
        ...
        $this->assertSame($this->row['Delivery Gender'], '');
        ...
        $this->assertSame($this->row['Invoice gender'], '');
        ...
        $this->assertSame($this->row['Product ID'], '2');
        ...
        $this->assertSame($this->row['Product Name'], 'Blouse - Color : White, Size : M');
        //array('name' => 'Product Price', 'field' => 'product_price', 'database' => 'order_detail', 'alias' => 'od'),
        $this->assertSame($this->row['Product Price'], '26.999852');
        ...
        $this->assertSame($this->row['Shop name'], 'test');
        //
        ...
        $this->assertSame($this->row['Order currency'], 'GBP');
        ...
        $this->assertSame($this->row['Employee name (last state)'], 'Test Test');
