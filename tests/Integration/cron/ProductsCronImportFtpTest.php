...
class ProductsCronImportFtpTest extends IntegrationTestCase
{
    ...
    private function createProductsDefaultExportModel()
    {
        ...
        $advancedExportClass->save_type = 1;
        $advancedExportClass->ftp_user_name = 'test@storepresta.com';
        $advancedExportClass->ftp_hostname = 'ftp.storepresta.com';
        $advancedExportClass->ftp_user_pass = 'aaaaaaaa';
        $advancedExportClass->ftp_directory = '';
        $advancedExportClass->ftp_port = 21;
...
//        return  _PS_ROOT_DIR_ . '/modules/advancedexport/csv/' . self::PRODUCTS . '/' . self::PRODUCTS . '_import.csv';
    ...
    private function createImportModel()
    {
        ...
        $import->entity = 1;
        $import->name = 'test';
        $import->import_from = \ImportFrom::getImportFromIdByName('ftp');
        $import->import_filename = 'mapping_products_import.csv';
        $import->filename = 'products_import.csv';
        $import->file_token = '';
        $import->url = '';
        $import->id_advancedexport = 0;
        $import->ftp_user_name = 'test@storepresta.com';
        $import->ftp_hostname = 'ftp.storepresta.com';
        $import->ftp_user_pass = 'aaaaaaaa';
