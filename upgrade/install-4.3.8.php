...
//    $delivery_other = true;
//
//    if(!UpgradeHelper::isColumnWithValueExists('field', 'invoice_other', 'advancedexportfield')) {
...
//    }
//
//    if(!UpgradeHelper::isColumnWithValueExists('field', 'delivery_other', 'advancedexportfield')) {
